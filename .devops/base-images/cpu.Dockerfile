...
# NOTE: Do NOT merge amd64/arm64 branches — arm64 requires GGML_CPU_ALL_VARIANTS=OFF
# Upstream uses a single branch with ON for both, which breaks arm64 builds
